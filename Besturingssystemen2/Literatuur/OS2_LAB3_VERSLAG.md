...
We avoided global synchronization by synchronizing the correct methods inside our STA. Whenever a resource is accessible by multiple threads (shared resource), we need to synchronize on this.
